...
#define UPD_MSG (uint)(0xC0000000) // format - key: [ C (2) - signs (4) - index (6) - v_x (10) - v_y (10)] payload : [theta (16) - psi (16)] Note that values are positive integers (v * 1000) and (theta, psi * 10000)
#define SAVE_MSG 52
